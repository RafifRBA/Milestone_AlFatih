...
from arm.ik_math_adv import ik_adv
...
class EndEffectorListener(Node):
    ...
    def on_timer(self):
        ...
        try:
            ...
            thetaC, thetaF, thetaT = ik_adv(p_x, p_y, p_z)
            ...
            self.get_logger().info(
                ...
                f'thetaC = {thetaC:.3f}, thetaF = {thetaF[0]:.3f}, thetaT = {thetaT[0]:.3f}'
                f'\nCalculated Thetas (lower):\n'
                f'thetaC = {thetaC:.3f}, thetaF = {thetaF[1]:.3f}, thetaT = {thetaT[1]:.3f}'
            )
