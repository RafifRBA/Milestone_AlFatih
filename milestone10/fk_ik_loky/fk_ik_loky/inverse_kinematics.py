...
from fk_ik_loky.ik_math import ik_kaki_loky

class EndEffectorListener(Node):
    def __init__(self):
        super().__init__('inverse_kinematics_listener')
    ...
    def on_timer(self):
        from_base = 'base_link'
        to_end_eff = 'leg1_end_effector_link'
        try:
            ...
            thetaC, thetaF, thetaT = ik_kaki_loky(p_x, p_y, p_z)
